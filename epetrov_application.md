...
* Ввод списка препаратов
* Какое дерево каким препаратом и когда было обработано
* Создание плана дальнейшей обработки
* Учет обработки деревьев и остальных растений в саду.
* График работ по обработке каждого растения конкретными препаратами с датами и периодичностью работ.
* Материал - язык kotlin
* Экспорт/Импорт сада
* *веб-версия
